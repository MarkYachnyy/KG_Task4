...
//
//        Model resultModel1 = new AffineBuilder().scale(3f,2f,1f).returnChangedModel(model1);
//
...
//
//        Model resultModel2 = new AffineBuilder().scale(3f,2f,1f)
//                .close().returnChangedModel(model2);
//
//        ArrayList<Vector3f> newNormals = (ArrayList<Vector3f>) resultModel2.getNormals();
//
